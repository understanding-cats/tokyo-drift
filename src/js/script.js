...
function getsessioninfo() {
  ...
  document.getElementById("worktime").innerText =
    "Work Session: " + work_insec / 60 + " mins";
  document.getElementById("shortbreak").innerText =
    "Short Break: " + sbreak_insec / 60 + " mins";
  document.getElementById("longbreak").innerText =
    "Long Break: " + lbreak_insec / 60 + " mins";
...
document.getElementById("currworktime").innerText =
  "Work Session: " + work_insec / 60 + " mins";
document.getElementById("currshortbreak").innerText =
  "Short Break: " + sbreak_insec / 60 + " mins";
document.getElementById("currlongbreak").innerText =
  "Long Break: " + lbreak_insec / 60 + " mins";
document.getElementById("currworkp").innerText =
  "Work Periods: " + work_periods;
